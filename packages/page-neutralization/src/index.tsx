...
import PageNeutralization from './neutralization';
...
function EcoNeutralizationApp ({ basePath }: Props): React.ReactElement<Props> {
...
export default React.memo(EcoNeutralizationApp);
