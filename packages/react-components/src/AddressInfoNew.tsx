    ...
    <>
      ...
      {balancesAll && balanceDisplay.available && (
        <>
          ...
          <span>
            {
              beautifulNumber(unitToEco(balancesAll.availableBalance.toString()).toString())
            }
          ECO2
  ...
  if (withBalanceToggle) {
    return (
      <>
        <Expander summary={
          balancesAll && <span>
            {beautifulNumber(unitToEco(balancesAll.freeBalance.add(balancesAll.reservedBalance).toString()).toString())}ECO2
          </span>
        }>
